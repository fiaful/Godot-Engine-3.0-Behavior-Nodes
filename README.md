...
I punti cardine del progetto saranno:
  ...
  - tutto free e opensource (chiunque può mettere mano al codice per adattarlo alle proprie necessità - chiunque è pregato di pubblicare eventuali bugfix alla comunità)
  - ogni nodo comportamento dovrà essere aggiunto come sottonodo del nodo al quale vuole aggiungere il comportamento stesso
  - tutti i parametri di configurazione del comportamento esposti (nessuno dovrà modificare il codice solo per variare i parametri)
...
Mi raccomando di commentare il codice!
